      ...
      <div className="container mx-auto flex justify-center items-center py-4 px-6">
        ...
        <nav>
          <ul className=" flex space-x-8 text-gray-700 font-medium lg-icon">
            <motion.li
              className="border border-[#747bff] bg-[#d8edf5] flex items-center overflow-hidden"
              initial={{ borderRadius: "100%", width: 50, height: 50 }}
              whileHover={{ borderRadius: "10px", width: 120 }}
